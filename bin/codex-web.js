...
if (!existsSync(targetDir)) {
  console.error(`codex-web: directory not found: ${targetDir}`);
  process.exit(1);
}
...
try {
  ...
  console.error("codex-web: failed to prepare wterm.wasm");
...
const env = {
  ...process.env,
  CODEX_WEB_CWD: targetDir,
  CODEX_WEB_NO_OPEN: noOpen ? "1" : "0",
  PORT: port,
  HOST: host,
};
